...
//        MyExpire();
    ...
    // 做一个解释： 这里不是权重越小或者权重越大的就会被淘汰掉。这里还是有算法。算法和 maxnum是一样。
    ...
    public static void ExpireSoft() throws InterruptedException {
        ...
        try {
            ...
            //抛出了OOM异常时
            //TimeUnit.SECONDS.sleep(1);
            System.out.println("OOM时读name："+cache.getIfPresent("name"));
            System.out.println("OOM时读age："+cache.getIfPresent("age"));
