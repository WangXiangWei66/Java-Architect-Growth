package com.bobo.mybatis.interceptor;
...
public class FirstInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        System.out.println("FirtInterceptor  拦截之前 ...."+invocation.getMethod());
        Object obj = invocation.proceed();
        System.out.println("FirtInterceptor  拦截之后 ...."+invocation.getMethod());
        return obj;
    }
